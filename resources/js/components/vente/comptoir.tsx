...
import { ClientPicker } from '@/components/vente/client-picker';
 ...
 *
 * Composant et non page : il s'ouvre en fenêtre au-dessus des factures et
 * devis. Vendre et facturer sont le même geste, les séparer obligeait à
 * ressaisir le panier une seconde fois pour éditer la pièce.
 *
 * L'enregistrement mène à la facture que la vente vient de produire, donc au
 * changement de page — la fenêtre se referme d'elle-même et `onEncaisse` n'a
 * qu'à prévenir le parent avant la navigation.
 */
export function Comptoir({
    ...
    function createCustomer(event: React.FormEvent) {
        ...
        router.post('/vente/client', nouveauClient, {
            preserveScroll: true,
            preserveState: true,
    ...
    const panier = (
        <div className="flex min-h-0 flex-col bg-card lg:h-full lg:rounded-xl lg:border lg:shadow-sm">
            ...
            <div className="space-y-3 border-t p-4">
                <div className="grid gap-2">
                    ...
                    <ClientPicker
                        ...
                        onChange={(id) =>
                            setCustomerId(
                                id === null ? NO_CUSTOMER : String(id),
                            )
                        }
                        onCreate={(saisi) =>
                            setNouveauClient({
                                // Ce qui a été tapé dans la recherche est
                                // repris : le nom cherché est presque toujours
                                // le nom à créer.
                                name: saisi,
                                phone: '',
                                email: '',
                ...
                <div className="grid grid-cols-2 gap-2">
                    <div className="grid gap-1.5">
                        ...
                        >
                            <SelectTrigger id="paiement" className="w-full">
                                <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                ...
                <DialogContent>
                    <form onSubmit={createCustomer} className="space-y-4">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Le nom suffit. La fiche se compl\u00e8tera plus
                                tard, depuis l\u2019\u00e9cran Clients.
                            </DialogDescription>
                        </DialogHeader>
                        ...
                        {nouveauClient ? (
                            <>
                                ...
                                <p className="rounded-md bg-muted px-3 py-2 text-xs text-muted-foreground">
                                    Si ce num\u00e9ro existe d\u00e9j\u00e0, la
                                    fiche existante sera reprise au lieu
