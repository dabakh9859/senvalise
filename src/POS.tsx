...
export default function POS({onOpenInvoice}:PosProps){
  ...
  useEffect(()=>{
    ...
    try{
      ...
      if(lines.length){setCart(lines);setRestoredNote(lines.reduce((sum,line)=>sum+line.quantity,0))}
